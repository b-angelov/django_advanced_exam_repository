"""
Django settings for izpitnik project.
...
CORS_ALLOWED_ORIGINS = config('CORS_ORIGINS_WHITELIST',cast=Csv(post_process=list))
...
WSGI_APPLICATION = 'izpitnik.wsgi.application'
